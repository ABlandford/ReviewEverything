...
class Home extends React.Component {
  ...
  constructor(props) {
    super(props); 
    this.state = { valueReview: "", valueRating: 0, loggedin: true, user: {}, searchTitle: "", searchDescription: "", searchImage: "", search: "", actor: "", searchId: 0, email:"", userId: "", username:"", genre: 28, specificR: {} };
  ...
  getReviews(){
    ...
    const date = { userId: this.state.userId, userfname: this.state.fname, userlname: this.state.lname, review: this.state.valueReview, rating: this.state.valueRating, movieId: this.state.searchId, email: this.state.email, username: this.state.username }
  ...
  componentDidMount() {
    ...
    this.setState({ user: { fname: currentUser.fname, lname: currentUser.lname, userId: currentUser._id, username: currentUser.username } });
  }
